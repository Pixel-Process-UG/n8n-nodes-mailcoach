...
- Aligned with Mailcoach PHP SDK methods `addTags()` and `removeTags()`
- Support for managing subscriber tags independently from full subscriber updates

### Changed
- Updated node to match latest Mailcoach SDK functionality
- Improved tag management workflow with dedicated operations
